...
<html class="no-js" lang="en">
    <head>
        ...
        <link
            rel="shortcut icon"
            type="image/x-icon"
            href="{{ asset('prison/img/favicon.png') }}"
        />
                    ...
                    <div class="col-lg-10 d-lg-block d-none">
                        <div class="main-menu text-center">
                            <nav>
                                <ul>
                                    <li
                                        class="{{ request()->routeIs('prison.home') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.home') }}"
                                            >Home</a
                                        >
                                    ...
                                    <li
                                        class="{{ request()->routeIs('prison.about') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.about') }}"
                                            >About</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.features') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.features') }}"
                                            >Features</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.pricing') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.pricing') }}"
                                            >Plans</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.works') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.works') }}"
                                            >How It Works</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.support') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.support') }}"
                                            >FAQ</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.services') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.services') }}"
                                            >Services</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.contact') ? 'active' : '' }}"
                                    >
                                        <a href="{{ route('prison.contact') }}"
                                            >Contact</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.login')||request()->routeIs('prison.register')||request()->routeIs('prison.dashboard')||request()->routeIs('user.setting')||request()->routeIs('user.buymore')||request()->routeIs('user.accounts')||request()->routeIs('user.usage')||request()->routeIs('user.expiry') ? 'active' : '' }}"
                                    >
                                        <a
                                            href="{{
                                                route('prison.dashboard')
                                            }}"
                                            >My Account</a
                                        >
                                    </li>
                                    <li
                                        class="{{ request()->routeIs('prison.cart') ? 'active' : '' }}"
                                    >
                                        <a
                                            @auth
                                            href="{{ route('prison.cart') }}"
                                            @else
                                            href="{{
                                                url('/login?redirect=cart')
                                            }}"
                                            @endauth
                                            ><strong
                                                >{{ count($orders) }}
        ...
        <footer class="prison-footer">
            ...
            <div id="footer-menu">
                <ul>
                    ...
                    |
                    <li>
                        <a href="{{ route('prison.cancel') }}"
                            >Canellation Policy</a
                        >
                    </li>
                    |
                    <li>
                            ...
                            <div class="tab-content">
                                ...
                                >
                                    <div class="login-form-container">
                                        <span
                                            >Please login using account detail
                                            bellow.</span
                                        >
                                ...
                                >
                                    <div class="register-form">
                                        <span
                                            >Please sign up using account detail
                                            bellow.</span
                                        >
                                        <form action="#" method="post">
                                            <input
