                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li
                                    class="pcoded-hasmenu {{ request()->routeIs('content.home')||request()->routeIs('content.about')||request()->routeIs('content.feature')||request()->routeIs('content.service')||request()->routeIs('content.work')||request()->routeIs('content.faq') ? 'active pcoded-trigger' : '' }}">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Content</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="{{ request()->routeIs('content.home') ? 'active' : '' }}">
                                            <a href="{{
                                                        route('content.home')
                                                    }}" class="
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Home</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="{{ request()->routeIs('content.about') ? 'active' : '' }}">
                                            <a href="{{
                                                        route('content.about')
                                                    }}" class="
                                                        waves-effect waves-dark
                                                ...
                                                <span class="pcoded-micon"><i class="
                                                            ...
                                                            "></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">About</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="{{ request()->routeIs('content.feature') ? 'active' : '' }}">
                                            <a href="{{
                                                ...
                                                <span class="pcoded-micon"><i class="
                                                            ...
                                                            "></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.alert">Features</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="{{ request()->routeIs('content.service') ? 'active' : '' }}">
                                            <a href="{{
                                        ...
                                        <li class="{{ request()->routeIs('content.work') ? 'active' : '' }}">
                                            <a href="{{
                                                        route('content.work')
                                                    }}" class="
                                                        waves-effect waves-dark
                                                ...
                                                <span class="pcoded-micon"><i class="
                                                                ti-angle-right
                                                            "></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">How It
                                                    Works</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="{{ request()->routeIs('content.faq') ? 'active' : '' }}">
                                            <a href="{{
                                                        route('content.faq')
                                                    }}" class="
                                                        waves-effect waves-dark
                                                ...
                                                <span class="pcoded-micon"><i class="
                                                            ...
                                                            "></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">FAQ</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li
                                    class="pcoded-hasmenu {{request()->routeIs('admin.products.index') ? 'active pcoded-trigger' : '' }}">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="fas fa-dollar-sign"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.basic-components.main">Peckages</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="{{ request()->routeIs('admin.products.index') ? 'active' : '' }}">
                                            <a href="{{
                                                ...
                                                <span class="pcoded-micon"><i class="
                                                            ...
                                                            "></i></span>
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs">Peckage</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="{{ request()->routeIs('admin.promos.index') ? 'active' : '' }}">
                                    <a href="{{ route('admin.promos.index') }}" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Promo
                                            Codes</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
