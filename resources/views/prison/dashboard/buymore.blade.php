    ...
    <div class="row">
        ...
        <div class="col-12 col-md-9">
            <div class="border rounded ml-md-4 mt-3 mt-md-0 dash__width">
                <div class="card__header p-3">Add Extra Minutes</div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 position-relative">
                            <div class="form-check">
                                ...
                                <label
                                    for="paypal"
                                    class="radio-label font-weight-bold"
                                    >Pay by PayPal</label
                                >
                            </div>
                        </div>
                    ...
                    <div class="row py-2 px-5">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="cardNumber" class="font-weight-bold"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="mmNumber" class="font-weight-bold"
                                    >Expiration * (MM)</label
                                >
                                <input
                                    type="number"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="cardYear" class="font-weight-bold"
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="cardCVC" class="font-weight-bold"
                                    >Card CVC *</label
                                >
                                <input
                                    type="number"
