                        ...
                        <table class="table table-bordered table-hover tenant-dash mt-3">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{route('prison.voicemail.edit',$item->voicemail_id)}}"
                                        ...
                                        <form action="{{route('prison.voicemail.delete',$item->voicemail_id)}}"
                                            method="post" id='voicemail-{{$item->voicemail_id}}'>
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </td>
