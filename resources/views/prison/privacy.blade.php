...
<div id="about" class="feature-area bg-light pt-40 pb-60 fix">
    <div class="container">
        <h4 class="py-2"><b>Our commitment to your privacy </b></h4>
        <p>
            BDM System Ltd. ("We") are committed to protecting and respecting
            ...
            how we will treat it. For the purpose of the Data Protection Act
            1998 (the Act), the data controller is BDM System Ltd. of 17
            Windmill Centre Windmill Lane Southall UB2 4NJ
        </p>

        <h4 class="py-2"><b>Information we may collect from you</b></h4>
        <p>We may collect and process the following data about you:</p>
        <ul>
            <li>
                Information that you provide by filling in forms on our site
                www.prisontel.co.uk this includes information provided at the
                time of registering to use our site, subscribing to our service,
        ...
        <h4 class="py-2"><b>IP Addresses </b></h4>
        <p>
        ...
        <h4 class="py-2"><b>Where we store your personal data</b></h4>
        <p>
            ...
            or for one of our suppliers. Such staff maybe engaged in, among
            ...
            privacy policy. All information you provide to us is stored on our
        ...
        <h4 class="py-2"><b>Uses made of the information</b></h4>
        <p>
            Unless you opt-out, we may contact you from time to time with
            information regarding new features or products that we release. For
            administrative purposes, we may need to pass the information we
            collect to other companies. We may use third parties to carry out
            certain activities, for example measuring customer service or
            issuing our e-mails for us. Third parties will not be allowed to use
            your personal information for their own purposes. We never use or
            share the personally identifiable information provided to us online
            in ways unrelated to the ones described above without also providing
        ...
        <p>
            We may contact our customers by phone or electronic means (e-mail,
            SMS etc.) with information about goods and services similar to those
            which were the subject of a previous sale to you. If you do not want
            us to use your data in this way, or to pass your details on to third
            parties for marketing purposes, please do not tick the relevant box
        ...
        <h4 class="py-2">
            <b
                >Retention and handling of information and documents processed
                using our service
            </b>
        </h4>
        <p>
            You may subscribe to services (such as Fax to Email, Email hosting),
            which involve transmissions intended for you being passed through,
            or stored on our systems. Such material is ordinarily kept on our
            systems for the minimum amount of time practical, but may remain
            indefinitely depending on the practicalities of identifying material
            that requires deletion.
        </p>

        <p>
            We will not ordinarily access this material, except in the event of
            request by the Police as part of a criminal investigation or by any
            other legally entitled authorities or where permission has been
            obtained from you to do so (for instance in the event of tracing a
            fault).
        </p>

        <p>
            Please note if you are using our Virtual Receptionist service, our
            staff may listen to your calls for quality and training purposes. We
            have in place appropriate physical, electronic, and managerial
            procedures to ensure that this is adhered to.
        </p>

        <h4 class="py-2"><b>Disclosure of your information</b></h4>
        <p>
            ...
            Act 2006. We may disclose your personal information to third
            parties:
        </p>
        <ul>
            <li>
            ...
            <li>
                If BDM System Ltd. or substantially all of its assets are
            ...
            <li>
                ...
                or safety of BDM System Ltd., our customers, or others.
            </li>
        </ul>
        <p>
        ...
        <h4 class="py-2">
            <b>How can you access or correct your information?</b>
        </h4>

        <p>
            You can access all your personally identifiable information that we
            collect online and maintain by sending us an email. We use this
        ...
        <h4 class="py-2"><b>Your rights</b></h4>
        <p>
            ...
            processing by not ticking the box during the sign up process. You
            can also exercise the right at any time by contacting us at
            support@prisontel.co.uk
        </p>
        <p>
        ...
        <h4 class="py-2"><b>Access to information</b></h4>
        <p>
        ...
        <h4 class="py-2"><b>Changes to your privacy policy</b></h4>
        <p>
        ...
        <h4 class="py-2"><b>Contact</b></h4>
        <p>
            Questions, comments and requests regarding this privacy policy are
            welcomed and should be addressed to support@prisontel.co.uk
        </p>
    </div>
</div>
@endsection
